...
request.generateRVNCashWithdrawal = (
  ...
  const msg_Json = {
    message: `You Have Request Cash WithDrawal Without Using ATM CARD With Amount ${formattedAmount} on browser: ${deviceInfo.browserName} at ${deviceInfo.osName} with ip: ${deviceInfo.ip}and latitude ${position.latitude}, longitude ${position.longitude}`,
    ip: deviceInfo.ip,
    latitude: position.latitude,
    longitude: position.longitude,
    deviceBrowser: deviceInfo.browserName,
